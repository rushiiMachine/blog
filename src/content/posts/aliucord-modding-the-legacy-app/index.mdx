...
<div className="flex gap-2">
    <MDXImage src={import("./manager_2.png")} alt="Manager installer screen"/>
    <MDXImage src={import("./manager_1.png")} alt="Manager home screen"/>
</div>
...
<MDXImage src={import("./uwu.png")} alt="Discord UI but every text element is replaced with uwu"/>
