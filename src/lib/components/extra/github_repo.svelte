...
<div class="card bg-base-100 !bg-base-200 my-4 overflow-x-auto">
    <div class="p-6">
        {#if info}
            <div class="flex">
            ...
            <div class="card-actions -ml-2">
                <button class="btn btn-sm btn-ghost" on:click={open(info.html_url + "/stargazers")}>
                    <svg
                            aria-hidden="true"
                            viewBox="0 0 16 16"
                            version="1.1"
                    ...
                    {kFormatter(info.stargazers_count)}
                </button>
                {#if info.license}
                    <a class="btn btn-sm btn-ghost" rel="noopener noreferrer external" target="_blank" href="https://choosealicense.com/licenses/{info.license.key}">
                        <svg
                                aria-hidden="true"
                                viewBox="0 0 16 16"
                                version="1.1"
                ...
                {/if}
                <button class="btn btn-sm btn-circle btn-ghost ml-auto" on:click={open(info.html_url)}>
